...
SVM is a powerful algorithm that finds the \textbf{optimal hyperplane} (boundary) that best separates different classes in an N-dimensional space. It aims to \textit{maximize the margin}, that is the distance between the hyperplane and the nearest data points from each class.
