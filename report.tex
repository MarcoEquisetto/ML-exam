...
This report presents a comprehensive analysis of the Star Classification dataset, aiming to compare the performance of multiple supervised and unsupervised models. The study investigates how data preprocessing heavily impacts model outcomes and explores how different techniques can be combined to leverage their respective strengths.\\Four distinct supervised learning models are evaluated: \textbf{K-Nearest Neighbors (KNN)}, \textbf{Random Forest}, \textbf{Support Vector Machines (SVM)}, and \textbf{Logistic Regression}. 
 ...
 Model performance is primarily evaluated using the \textbf{F1-score} for classification tasks, while \textbf{Adjusted Rand Index (ARI)} and \textbf{Silhouette Coefficient} are utilized for clustering validation. 
\end{abstract}
